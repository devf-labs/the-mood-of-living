...
?>
<div <?php
        if ( $el_class ) echo 'class="thememove-gmaps ' . esc_attr($el_class) . '"';
        else echo 'id="map-canvas" class="thememove-gmaps"';
    ?>
                ...
                if (gmMapDiv.length) {
                    ...
                    gmMapDiv.gmap3({
                        ...
                        marker: {
                            ...
                            options: {
                                <?php if ($marker_icon == '') { ?>
                                icon: "<?php echo esc_js(THEME_ROOT); ?>/images/map-marker.png",
                                <?php } else { ?>
                        ...
                        map: {
                            options: {
                                ...
                                <?php } ?>
                                <?php } else { ?>
                                styles: <?php echo esc_js($map_style_snippet); ?>,
                                <?php } ?>
                                <?php } ?>
                            }
                        }
