...
if (!class_exists('TM_Facebook_Widget')) {
  ...
  class TM_Facebook_Widget extends WP_Widget
  {
    ...
    function __construct()
    {
      parent::__construct(
        'tm_facebook',
        __('ThemeMove - Facebook Page Like', 'thememove'),
        array('description' => __('Facebook Page "Like" button', 'thememove'))
      );
    }
    ...
    function form($instance) {
      ...
      <p>
        <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php _e('Facebook Page URL', 'thememove') ?></label>
      ...
      <p>
        <label for="<?php echo esc_attr($this->get_field_id('width')); ?>"><?php _e('Width', 'thememove') ?></label>
      ...
      <p class="help"><?php _e('The pixel width of the embed (Min. 180 to Max. 500)', 'thememove'); ?></p>
      <p>
        <label for="<?php echo esc_attr($this->get_field_id('height')); ?>"><?php _e('Height', 'thememove') ?></label>
      ...
      <p class="help"><?php _e('The pixel height of the embed (Min. 70)', 'thememove'); ?></p>
      <p>
        ...
        <label for="<?php echo esc_attr($this->get_field_id('use_small_header')); ?>"><?php _e('Use Small Header', 'thememove') ?></label>
      </p>
      <p class="help"><?php echo _e('Uses a smaller version of the page header', 'thememove'); ?></p>
      <p>
        ...
        <label for="<?php echo esc_attr($this->get_field_id('adapt_to_container')); ?>"><?php _e('Adapt to shortcode container width', 'thememove') ?></label>
      </p>
      <p class="help"><?php echo _e('Shortcode will try to fit inside the container', 'thememove'); ?></p>
      <p>
        ...
        <label for="<?php echo esc_attr($this->get_field_id('hide_cover')); ?>"><?php _e('Hide cover photo', 'thememove'); ?></label>
      </p>
      <p class="help"><?php echo _e('Hide the cover photo in the header', 'thememove'); ?></p>
      <p>
        ...
        <label for="<?php echo esc_attr($this->get_field_id('show_face')); ?>"><?php _e('Show Friend\'s Faces', 'thememove'); ?></label>
      </p>
      <p class="help"><?php echo _e('Show profile photos when friends like this', 'thememove'); ?></p>
      <p>
        ...
        <label for="<?php echo esc_attr($this->get_field_id('show_posts')); ?>"><?php _e('Show Page Posts', 'thememove'); ?></label>
      </p>
      <p class="help"><?php echo _e('Show posts from the Page\'s timeline', 'thememove'); ?></p>
      <?php
    }
  } // end class
} // end if