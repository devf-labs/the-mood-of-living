...
Class ThemeMove_Responsive {
  ...
  private function sizeControl ($size_key) {
    if ('md' === $size_key) {
      return '<span class="vc_description">' . __( 'Default value from "Number of items in a row" attribute', 'thememove' ) . '</span>';
    }
  ...
  public function render() {
    ...
    $html .= '<div class="tm_responsive" data-responsive="true">
             ...
             <table class="vc_table tm_table tm_responsive-table">
              <tr>
                <th>' . __('Device', 'thememove') . '</th>
                <th>' . __('Item width', 'thememove') . '</th>
                <th>' . __('Hide on device?', 'thememove') . '</th>
              </tr>
            ';
...
vc_add_shortcode_param( 'thememove_responsive', 'thememove_responsive_settings_field', get_template_directory_uri() . '/inc/vc-params/thememove-responsive/thememove_responsive.js');
