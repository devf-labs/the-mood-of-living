...
$class = '';
if(has_post_thumbnail() && !$infinity_hide_featured_image) {
  $class = 'col-sm-8';
}
?>
...
<article <?php post_class('post-list-item row'); ?>>
  <?php if(has_post_thumbnail() && !$infinity_hide_featured_image) { ?>
    <div class="col-sm-4 post-img">
      <a href="<?php echo get_permalink() ?>"><?php the_post_thumbnail('list-thumb'); ?></a>
  ...
  <div class="<?php echo esc_attr($class ? $class . ' ' : ''); ?>list-content">
    ...
    <div class="entry-content">
      <p><?php echo thememove_string_limit_words(get_the_excerpt(), 15); ?>&hellip;</p>
