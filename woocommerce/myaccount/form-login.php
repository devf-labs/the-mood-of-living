...
<div class="col2-set" id="customer_login">
	...
	<div class="col-1">
		...
		<?php
		/*
		 * Print the Account Benefits Info info.
		 */
		$account_benefits_info = ot_get_option( 'account_benefits_info' );
		?>
				
		<?php if ( ! empty( $account_benefits_info ) ) { ?>
			<?php echo $account_benefits_info; ?>
		<?php } ?>
...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="button minimal" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" />
				...
				?>"><?php _e( 'Forgot your password?', 'woocommerce' ); ?></a>
			</p>
		</form>
		
		<?php
		/*
		 * Print the Returning Customer Info info.
		 */
		$returning_customer_info = ot_get_option( 'returning_customer_info' );
		?>
				
		<?php if ( ! empty( $returning_customer_info ) ) { ?>
